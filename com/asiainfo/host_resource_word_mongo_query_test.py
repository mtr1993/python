...
def get_host_mongo_query_apps(publisher, hosts, db_connect):
    ...
    try:
        ...
        executor.end()
    logger.info(f'host_mongo_query_apps is {host_mongo_query_apps}')
    return host_mongo_query_apps
...
if __name__ == '__main__':
    ...
    try:
        ...
        host_mongo_query_apps_context = {'date_cycle': date_cycle, 'table': host_mongo_query_apps}
        ...
        local = os.path.join('/home/aihc/bhc/robot-node/.toolkit/doc_1_20190807', file_name)
        # 远程下载文件主机目录配置
